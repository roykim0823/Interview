...
public class SortAnim extends Applet {
	...
	static private
	static private
	final int ALG_ISORT = 0;
	final int ALG_SELSORT = 1;
	final int ALG_SHELLSORT = 2;
	final int ALG_HSORT = 3;
	final int ALG_QSORT = 4;
	final int ALG_QSORT2 = 5;
	int alg_num = ALG_ISORT;
	private void dosort()
	{
		switch(alg_num) {
			case ALG_ISORT:
			...
			shellsort(); break;
			heapsort(); break;
			qsort(0, n-1); break;case ALG_QSORT2:
		}
		qsort2(0, n-1); break;
	}
